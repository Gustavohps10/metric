"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; } function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } } function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; } var _class;// src/configFields.ts
...
var _connectorsdk = require('@timelapse/connector-sdk');
...
var RedmineAuthenticationStrategy = class {
  ...
  async authenticate(input) {
    try {
      ...
      return _connectorsdk.Either.success(authenticationResult);
    } catch (e) {
      return _connectorsdk.Either.failure(
        new (0, _connectorsdk.AppError)(
...
var RedmineBase = (_class = class {
  constructor(context) {;_class.prototype.__init.call(this);_class.prototype.__init2.call(this);
    this.context = context;
  }
  __init() {this.apiClient = null}
  __init2() {this.cachedApiKey = null}
  getAuthenticatedClient() {
    console.log("CONTEXT", this.context);
    const apiUrl = _optionalChain([this, 'access', _ => _.context, 'optionalAccess', _2 => _2.config, 'optionalAccess', _3 => _3.apiUrl]);
    const apiKey = _optionalChain([this, 'access', _4 => _4.context, 'access', _5 => _5.credentials, 'optionalAccess', _6 => _6.apiKey]);
  ...
  async findByMemberId(memberId, startDate, endDate) {
    ...
    const entries = response.data.time_entries.map(
      (entry) => ({
        ...
        issue: { id: _optionalChain([entry, 'access', _7 => _7.issue, 'optionalAccess', _8 => _8.id]) },
